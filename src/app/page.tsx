...
import { Play, LaptopMinimalCheck } from 'lucide-react';
        ...
        >
              ...
              <header>
                ...
                <div className="bg-primary py-3 text-center">
                  <h1
                    ...
                    style={{ color: 'hsla(224, 71.4%, 4.1%, 0.7)' }}
                  >
                  ...
                  <div className="flex items-center justify-center text-base md:text-lg" style={{ color: '#fefdee' }}>
                    <span>English ⇋ Turkish subtitle creation, dubbing, SDH and
                      transcription
                    </span>
                  </div>
                </div>
              ...
              <main>
                ...
                >
                  <div className="space-y-3 leading-relaxed text-base">
                    ...
                    <div className="w-full h-px bg-accent mx-auto my-2"></div>
                    <p>
          ...
          >
            <div className="text-center text-lg">
              <div className="flex items-center justify-center gap-2">
                <LaptopMinimalCheck className="h-6 w-6 text-accent" />
                <p>4000+ files delivered</p>
              </div>
              <p className="mt-1">
